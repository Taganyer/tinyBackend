...
namespace LogSystem {
    ...
    public:
        ...
        static uint32 create_logger(LinkNodeType type_,
                                    ...
                                    const LinkNodeID &node_,
                                    const LinkNodeID &parent_node_,
                                    Base::Time_difference init_time_,
                                    Base::Time_difference parent_init_time_,
                                    void* dest, uint32 limit);
    ...
    private:
        ...
        [[nodiscard]] std::string get_record_file_name(Base::Time_difference file_init_time) const;
    ...
    public:
        ...
        using FilenameFile = Base::BPTree<Base::BPTree_impl<Base::Time_difference, uint32>>;

        using LinkIndexFile = Base::BPTree<Base::BPTree_impl<Index_Key, Index_Value>>;

        using NodeDeletionFile = Base::BPTree<Base::BPTree_impl<Base::Time_difference, Index_Key>>;
        ...
        bool create_logger(const LinkServiceID &service,
                           ...
                           Base::Time_difference node_init_time);
        ...
        class QuerySet {
            ...
            using LocationSet = std::priority_queue<std::pair<Base::Time_difference, uint32>>;
            ...
            Base::Time_difference _current_file;
    ...
    private:
        ...
        struct Record {
            Base::Time_difference file = Base::Unix_to_now(), latest_time = file;
        ...
        [[nodiscard]] LinkLogReadFile get_log_file(Base::Time_difference file_init_time) const;

        [[nodiscard]] std::string get_log_name(Base::Time_difference file_init_time) const;

        void open_new_log_file(const Record &record, Base::Time_difference end_time);
