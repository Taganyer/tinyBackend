...
LinkLogger::LinkLogger(LogRank rank, const ServiceID &service, const NodeID &node,
                       bool is_branch, Time_difference end_timeout,
...
LinkLogger::LinkLogger(LogRank rank, const ServiceID &service,
                       const NodeID &node, Time_difference end_timeout,
                       LinkLogServer &server) :
    _rank(rank), _server(&server) {
...
LinkLogger::LinkLogger(LogRank rank, const ID &complete_id,
                       Time_difference end_timeout, LinkLogServer &server):
...
void LinkLogger::register_child_node(Type type, const NodeID &node_id,
                                     Time_difference create_timeout) const {
...
void LinkLogger::fork(const NodeID &child_node, Time_difference create_timeout) const {
    register_child_node(Fork, child_node, create_timeout);
}

void LinkLogger::follow(const NodeID &child_node, Time_difference create_timeout) const {
    register_child_node(Follow, child_node, create_timeout);
}

void LinkLogger::decision(const NodeID &child_node, Time_difference create_timeout) const {
    register_child_node(Decision, child_node, create_timeout);
}

void LinkLogger::rpc_fork(const NodeID &child_node, Time_difference create_timeout) const {
    register_child_node(RpcFork, child_node, create_timeout);
}

void LinkLogger::rpc_follow(const NodeID &child_node, Time_difference create_timeout) const {
    register_child_node(RpcFollow, child_node, create_timeout);
}

void LinkLogger::rpc_decision(const NodeID &child_node, Time_difference create_timeout) const {
